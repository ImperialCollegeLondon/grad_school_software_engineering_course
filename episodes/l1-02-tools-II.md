...
A simpler alternative formatter is [black](https://black.readthedocs.io/),
which has fewer options to fiddle with.
...
- 5 minutes to set up the formatter is redeemed across the time of the project
