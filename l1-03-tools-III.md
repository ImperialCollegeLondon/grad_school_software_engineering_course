...
via compilers, like [gfortran](https://gcc.gnu.org/wiki/GFortran) or Intel’s
[ifort and ifx](https://www.intel.com/content/www/us/en/developer/tools/oneapi/fortran-compiler.html)
...
- 5 minutes to setup a linter is redeemed across the time of the project i.e.
